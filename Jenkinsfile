pipeline {
    ...
    stages {
        ...
        stage('Ansible_Docker_build') {
            steps {
                ansiblePlaybook become: true, credentialsId: 'ansible_host', extras: '-e build_tag=$BUILD_ID', installation: 'ansible', inventory: 'ansible_playbooks/ansible.hosts', playbook: 'ansible_playbooks/create_docker_image.yml', vaultCredentialsId: 'ansible_vault_password'
            }
        }
    }
}
