    ...
    stages {
        ...
        stage('Ansible_MiniKube_Deploy') {
            steps {
                ...
                ansiblePlaybook credentialsId: 'ansible_host', extras: '-e workspace_dir=$WORKSPACE', installation: 'ansible', inventory: 'ansible_playbooks/ansible_hosts', playbook: 'ansible_playbooks/myapp-minikube-deploy.yml'
            }
        }
    }
}
